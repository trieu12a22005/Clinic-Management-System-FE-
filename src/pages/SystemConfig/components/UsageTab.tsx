  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: unknown, record: any) => (
        <HasPermission requiredPermissions={["medicine.delete"]} fallback="-">
          <Space>
            <Tooltip title="Xoá">
              <Popconfirm
    ...
    <div>
      <div className="flex items-center justify-between mb-6 gap-3">
        ...
        <Space>
          ...
          <HasPermission requiredPermissions={["medicine.add", "medicine.update"]}>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="add" type="primary" loading={addMutation.isPending} onClick={handleAdd}>
            Thêm
          </Button>,
        ]}
      >
        <Form form={addForm} layout="vertical" className="mt-4">
          <Form.Item label="Cách dùng" name="usage" rules={[{ required: true, message: "Vui lòng nhập cách dùng" }]}>
