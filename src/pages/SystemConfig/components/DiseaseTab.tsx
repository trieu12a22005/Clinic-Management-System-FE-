  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <HasPermission requiredPermissions={["system.manage"]} fallback="—">
          <Space>
            <Tooltip title="Sửa">
    ...
    <div>
      <div className="flex items-center justify-between mb-6 gap-3">
        ...
        <Space>
          ...
          <HasPermission requiredPermissions={["system.manage"]}>
      ...
      <Modal
        ...
        footer={[
          ...
          <Button key="add" type="primary" icon={<PlusOutlined />} loading={addMutation.isPending} onClick={handleAdd}>
            Thêm
          </Button>,
        ]}
      >
        <Form form={addForm} layout="vertical" className="mt-4">
          ...
          >
            <Input
              ...
              onChange={(e) => addForm.setFieldValue("diseaseID", e.target.value.toUpperCase())}
            />
          </Form.Item>
          <Form.Item
            label="Tên bệnh"
      ...
      >
        <Form form={editForm} layout="vertical" className="mt-4">
          <Form.Item label="Mã bệnh" name="diseaseID">
